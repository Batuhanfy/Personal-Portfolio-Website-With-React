      ...
      <Row>
         <Col xs="12">
            <div className="wp-header">
               <div className="logo">
                  <Link to="/">
                     <img src="../images/logo.jpg" height="75px" alt="Logo" />
                  </Link>
               </div>
                  ...
                  <Navbar expand="md" className="justify-content-center">
                     <Collapse isOpen={IsOpen} navbar>
                        <Nav className="mr-auto justify-content-center" navbar>
                           <NavItem className="buttons text-center">
                              <NavLink to="/about" className="buttons-a" tag={Link}>
                                 <i>
                           ...
                           <NavItem className="buttons text-center">
                              <NavLink to="/projects" className="buttons-a" tag={Link}>
                                 <i>
                                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                           ...
                           <NavItem className="buttons text-center">
                              <NavLink href="/portfolyo" className="buttons-a" tag={Link}>
                                 <i>
...
<div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 mb-4 mt-4 ">
                <div class="sticky-div bg-light p-3">
                    Sol Menü İçerik
                </div>
            </div>
            <div class="col-lg-8 col-md-8 col-xs-12 mb-4 mt-4 ">
                <div class="content-div bg-white p-3 rounded rounded-lg">
                    <h1>Orta İçerik</h1>
                    <p>
                        Bu alana uzun içerik ekleyebilirsiniz. Bu div yukarıdan aşağıya kayarken, yanlardaki divler sabit kalacaktır.
                    </p>
                    <p>
                        Daha fazla içerik...
                    </p>
